...
class InvoiceRepoTest < Minitest::Test
  ...
  def test_that_find_by_id_method_returns_invoice_by_id
    ...
    assert_nil invoices.find_by_id("this is an id")
  ...
  def test_find_all_invoice_by_customer_id_method_returns_correct_invoices
    ...
    assert_instance_of Array, invoices.find_all_by_customer_id(3)
    assert_equal [], invoices.find_all_by_customer_id("this is an id")
  ...
  def test_find_all_by_merchant_id_method_returns_correct_invoices
    ...
    assert_instance_of Array, invoices.find_all_by_merchant_id(3)
    assert_equal [], invoices.find_all_by_merchant_id("merchant id")
  ...
  def test_find_all_by_status_returns_correct_invoices
    ...
    assert_equal [], invoices.find_all_by_status("status?????")
    assert_equal desired_invoices, invoices.find_all_by_status(:pending)
  end

  def test_find_merchant_returns_correct_merchant_by_id
    desired_merchant = @sales_engine.merchants.merchants[1]

    assert_equal desired_merchant, invoices.find_merchant(1)
  end

  def test_find_all_items_for_invoice_id
    assert_instance_of Array, invoices.find_all_items(1)
    assert_instance_of Item, invoices.find_all_items(1)[1]
  end
end
